...
const Bio = () => {
    return (
        <div className='bio'>
            ...
            <p>I have done my <span className='glow'>BTech</span> in <span className='glow'>Biotechnology</span> from <span className='glow'>IIT Jodhpur</span> (2022). During my BTech, I have served as an <span className='glow'>Undergraduate Student Researcher</span> in the <span className='glow'>Computational Biology lab</span> under the guidance of <a href='http://home.iitj.ac.in/~sushmitapaul/' rel='noopener noreferrer' target='_blank'>Dr Sushmita Paul</a>. My research work primarily involved the investigation and development of novel machine learning algorithms for biological data. During my time there, we have published two papers in a reputed peer-reviewed journal and a highly competitive international conference respectively.</p>
